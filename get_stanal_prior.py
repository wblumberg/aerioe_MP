...
"""
This code assumes that we're getting only analysis data from the prior.
No forecast data is used in the development of the prior dataset.

This script is meant to be run in a stand-alone setting.  It is not configured
to be referenced to by a function call.
